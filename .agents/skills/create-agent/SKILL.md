...
This skill guides you through creating custom subagents for opencode. Subagents are specialized AI assistants that run in isolated contexts with custom system prompts.
...
|----------|-------|----------|
| `.opencode/agents/` | Current project | Higher |
| `~/.opencode/agents/` | All your projects | Lower |

When multiple subagents share the same name, the higher-priority location wins.

**Project subagents** (`.opencode/agents/`): Ideal for codebase-specific agents. Check into version control to share with your team.

**User subagents** (`~/.opencode/agents/`): Personal agents available across all your projects.
...
- **Project-level** (`.opencode/agents/`): For codebase-specific agents shared with team
- **User-level** (`~/.opencode/agents/`): For personal agents across all projects
...
### Subagent Not Found
- Ensure file is in `.opencode/agents/` or `~/.opencode/agents/`
